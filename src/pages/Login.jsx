      ...
      <div className="onb-hero" style={{
        ...
        <div style={{ position: "relative", zIndex: 1, animation: "fadeInLeft 0.8s ease both" }}>
          ...
          <h1 style={{ fontSize: 44, fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.03em", marginBottom: 20, color: "#FFFFFF" }}>
            Welcome back to{" "}
            <span style={{ background: "linear-gradient(135deg, #C8FF00 0%, #A5E600 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>AI Fitness</span>{" "}
            <span style={{ background: "linear-gradient(135deg, #A5E600 0%, #C8FF00 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Mentor</span>
          </h1>
        ...
        <div style={{ width: "100%", maxWidth: 420, animation: "fadeInRight 0.8s ease 0.2s both" }}>
          ...
          <form onSubmit={handleEmailLogin}>
            ...
            <div style={{ textAlign: "right", marginBottom: 20 }}>
              <Link to="/forgot-password" style={{ color: "#C8FF00", fontSize: 13, textDecoration: "none", fontWeight: 500 }}>
                Forgot password?
              </Link>
            </div>
          ...
          <p style={{ textAlign: "center", marginTop: 28, fontSize: 14, color: "rgba(160,160,160,0.6)" }}>
            ...
            <Link to="/signup" style={{ color: "#C8FF00", fontWeight: 600, textDecoration: "none" }}>Create account</Link>
          </p>
        </div>
      </div>
    </div>
