export { fmt, today, weekAgo, uid, formatChatTime, fmtPace, fmtDuration, fmtDurationLong } from "./formatting";
...
export { calcE1RM, calcVolume, calcWeeklyVolume, calcStreak, calcCalories, haversine } from "./calculations";

export { USDA_API_KEY, USDA_BASE, usdaSearch, usdaDebouncedSearch } from "./usda";

export { useAICoach, callAIProvider, generateMockResponse, buildUserContext, buildSystemPrompt, renderMarkdown, isUsingMock } from "./aiCoach";
